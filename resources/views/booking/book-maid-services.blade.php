...
<head>
	<meta charset="UTF-8">
	<title>Book - Maid Services</title>
					...
					<div class="row align-items-center">
						<div class="col-lg-12">
							<div class="contact-form-dv">
                                ...
                                @endif
								<form method="post" action="{{ url('/book_maid') }}" id="contact-form">
                                @csrf
									...
									<div class="form-group">
										<input type="number" name="numberOfRooms" class="form-control numberOfRooms" placeholder="Enter Number of Rooms" required>
									</div><!--form-group end-->
									<div class="form-group">
