...
<head>
	<meta charset="UTF-8">
	<title>Book - Packers and Movers</title>
					...
					<div class="row align-items-center">
						<div class="col-lg-12">
							<div class="contact-form-dv">
                                ...
                                @endif
								<form method="post" action="{{ url('/book_packers_movers') }}" id="contact-form">
                                @csrf
									...
									<div class="form-group">
										<input type="text" name="destinationAddress" class="form-control destinationAddress" placeholder="Enter Destination Address" required>
									</div><!--form-group end-->
									<div class="form-group">
